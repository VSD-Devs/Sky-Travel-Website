...
const popularDestinations = [
  {
    ...
    name: 'Barcelona',
    code: 'BCN',
    image: 'https://images.unsplash.com/photo-1583422409516-2895a77efded?ixlib=rb-4.0.3&q=80&w=800',
    description: 'Iconic architecture by Gaudí, bustling markets, beautiful beaches and renowned cuisine.',
    flightTime: '~2h 15m'
  },
  {
    id: 'madrid',
    name: 'Madrid',
    code: 'MAD',
    image: 'https://images.unsplash.com/photo-1539037116277-4db20889f2d4?ixlib=rb-4.0.3&q=80&w=800',
    description: 'Spain\'s vibrant capital with world-class museums, elegant boulevards and beautiful parks.',
    flightTime: '~2h 30m'
  },
  {
    id: 'mallorca',
    ...
    description: 'The largest Balearic island with stunning beaches, mountain villages and a rich history.',
    flightTime: '~2h 40m'
  },
  {
    id: 'malaga',
    ...
    description: 'The heart of Costa del Sol with beautiful beaches, historic sites and Andalusian charm.',
    flightTime: '~2h 50m'
  },
];
...
const countryInfo = {
  ...
  travelTips: [
    'Many shops close for siesta in the afternoon, especially in smaller towns',
    'Dinner is typically eaten late, around 9-10pm',
    'Tipping is common but modest (5-10%) compared to UK standards',
    'Public transport is excellent in major cities and between popular destinations'
  ]
};
...
export default function SpainPage() {
  ...
  useEffect(() => {
    const fetchFlights = async () => {
      try {
        setLoading(true);
        const response = await fetch('/api/country-flights?code=ES');
        
        if (!response.ok) {
          throw new Error('Failed to fetch flights to Spain');
        }
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 z-0">
          <div className="relative w-full h-full">
            <Image 
              src="https://images.unsplash.com/photo-1511527661048-7fe73d85e9a4?ixlib=rb-4.0.3&q=80&w=800"
              alt="Beautiful view of Park Güell in Barcelona, Spain"
              priority
              fill
              sizes="100vw"
          ...
          <div className="mx-auto max-w-5xl">
            <div className="text-center mb-8 md:mb-10">
              ...
              <p className="text-blue-100 text-lg md:text-xl max-w-2xl mx-auto">
                Discover vibrant cities, stunning beaches and rich culture with direct flights from the UK
              </p>
            </div>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-600 mb-8 text-center max-w-2xl mx-auto">
            Direct flights from the UK to popular Spanish destinations
          </p>
          ...
          <div className="flex flex-col lg:flex-row gap-10 items-start">
            <div className="flex-1">
              ...
              <p className="text-gray-600 mb-6">
                Spain, on Europe's Iberian Peninsula, offers an incredible diversity of experiences, from the golden beaches of the Costa del Sol and the Balearic Islands to the artistic treasures of Madrid and Barcelona.
              </p>
              <p className="text-gray-600 mb-6">
                With its vibrant culture, delicious cuisine, and welcoming atmosphere, Spain continues to be one of Europe's most popular destinations.
              </p>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-600 mb-8 text-center max-w-2xl mx-auto">
            Explore these amazing Spanish destinations with direct flights from the UK
          </p>
      ...
      <section className="py-12 md:py-16 bg-gradient-to-r from-blue-700 to-blue-900 text-white">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold mb-12 text-center">Why Visit Spain?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold mb-3">Perfect Climate</h3>
              <p className="text-blue-100">With over 300 days of sunshine per year in coastal areas, Spain offers an ideal climate for beach holidays, outdoor activities, and city exploration year-round.</p>
            </div>
            ...
            <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold mb-3">Rich Heritage</h3>
              <p className="text-blue-100">From Roman ruins to Moorish palaces, Gothic cathedrals to modernist masterpieces, Spain's historical and cultural legacy spans thousands of years.</p>
            </div>
            ...
            <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold mb-3">Diverse Experiences</h3>
              <p className="text-blue-100">Whether you're seeking beach relaxation, mountain adventure, world-class art museums, or vibrant nightlife, Spain offers an incredible variety of experiences.</p>
            </div>
          </div>
        </div>
      </section>
