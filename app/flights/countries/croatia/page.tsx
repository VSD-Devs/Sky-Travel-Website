...
import { Plane, Clock, Info, MapPin, Calendar, ArrowRight, Sun, Sparkles, Check, Waves } from 'lucide-react';
...
const popularDestinations = [
  {
    ...
    description: 'Explore the stunning medieval walled city known as the "Pearl of the Adriatic" with its limestone streets and terracotta rooftops.',
    flightTime: '~2h 55m'
  },
  {
    id: 'split',
    name: 'Split',
    code: 'SPU',
    image: '/images/croatia-split.jpg',
    description: 'Discover this ancient coastal city built around the Roman Diocletian\'s Palace with its vibrant waterfront.',
    flightTime: '~2h 40m'
  },
  {
    id: 'zagreb',
    name: 'Zagreb',
    code: 'ZAG',
    image: '/images/croatia-zagreb.jpg',
    description: 'Visit Croatia\'s capital with its charming medieval old town, vibrant café culture and impressive museums.',
    flightTime: '~2h 30m'
  },
  {
    id: 'zadar',
    name: 'Zadar',
    code: 'ZAD',
    image: '/images/croatia-zadar.jpg',
    description: 'Experience Roman ruins, medieval churches, cosmopolitan cafés and unique sea organ on the Dalmatian coast.',
    flightTime: '~2h 35m'
  },
];
...
const countryInfo = {
  ...
  travelTips: [
    'The coastal areas can be very crowded in July and August',
    'Ferry services connect most of the islands during summer',
    'Tipping around 10% is customary in restaurants',
    'Most locals speak English, especially in tourist areas',
    'Croatian cuisine varies by region with seafood on the coast and meat dishes inland'
  ]
};
...
export default function CroatiaPage() {
  ...
  useEffect(() => {
    const fetchFlights = async () => {
      try {
        setLoading(true);
        const response = await fetch('/api/country-flights?code=HR');
        
        if (!response.ok) {
          throw new Error('Failed to fetch flights to Croatia');
        }
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 z-0">
          <div className="relative w-full h-full">
            <Image 
              src="/images/croatia-dubrovnik.jpg"
              alt="Stunning aerial view of Dubrovnik's old town and Adriatic Sea"
              priority
              fill
              sizes="100vw"
          ...
          <div className="mx-auto max-w-5xl">
            <div className="text-center mb-8 md:mb-10">
              ...
              <p className="text-blue-100 text-lg md:text-xl max-w-2xl mx-auto">
                Discover crystal-clear waters, ancient walled cities and stunning islands with direct flights from the UK
              </p>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-10 items-start">
            <div className="flex-1">
              ...
              <p className="text-gray-600 mb-6">
                Croatia is a stunning Mediterranean country featuring over 1,000 islands, ancient walled towns, and some of Europe's clearest waters. With its unique blend of Central European, Mediterranean, and Balkan influences, Croatia offers visitors an extraordinary mix of history, culture, cuisine, and natural beauty.
              </p>
              <p className="text-gray-600 mb-6">
                From the medieval streets of Dubrovnik and Split to the pristine beaches of Hvar and Brač, and from the cascading waterfalls of Plitvice Lakes to the vibrant capital of Zagreb, Croatia appeals to history enthusiasts, food lovers, sailing enthusiasts, and nature admirers alike.
              </p>
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-600 mb-8 text-center max-w-2xl mx-auto">
            Explore these amazing Croatian destinations with direct flights from the UK
          </p>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-600 mb-8 text-center max-w-2xl mx-auto">
            Direct flights from the UK to popular Croatian destinations
          </p>
      ...
      <section className="py-12 md:py-16 bg-gradient-to-r from-blue-700 to-blue-900 text-white">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold mb-12 text-center">Why Visit Croatia?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold mb-3">Stunning Coastline</h3>
              <p className="text-blue-100">Discover over 1,200 islands, crystal-clear waters, hidden coves and beautiful beaches along the Adriatic coast.</p>
            </div>
            ...
            <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold mb-3">Historic Walled Cities</h3>
              <p className="text-blue-100">Wander through medieval streets, ancient Roman ruins and imposing Venetian fortresses in Dubrovnik, Split and Zadar.</p>
            </div>
            ...
            <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
              ...
              <p className="text-blue-100">Experience the cascading waterfalls of Plitvice Lakes, dramatic mountains of Paklenica, and lush forests of Krka National Park.</p>
            </div>
          </div>
        </div>
      </section>
