...
export default function PlanTripPage() {
  ...
  return (
    <div className="h-full min-h-screen bg-white">
      ...
      <div className="relative h-full min-h-screen flex flex-col items-center justify-center p-6">
        {/* Main Form Container */}
        <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <div className="w-full mb-10">
            ...
            <div className="flex justify-between mt-3 text-base font-medium text-gray-600">
          ...
          {currentStep === 1 && (
            <div className="space-y-8">
              <div className="text-center mb-8">
                <h1 className="text-3xl font-semibold text-gray-900">Where would you like to go?</h1>
                <p className="text-lg text-gray-600 mt-2">Choose your destination and trip type</p>
              </div>

              <div className="space-y-6">
                <div>
                  <div className="relative">
                    <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 w-6 h-6 text-blue-600" />
                    <input
                      type="text"
                      value={destination}
                      onChange={(e) => setDestination(e.target.value)}
                      className="w-full pl-12 pr-4 py-4 text-lg rounded-xl border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-100 outline-none transition-colors"
                ...
                <div>
                  <div className="grid grid-cols-2 gap-4">
                    <button 
                      ...
                      className={`flex items-center gap-3 p-5 rounded-xl border-2 transition-all duration-200 ${
                        tripType === 'flight' 
                    ...
                    >
                      ...
                      <span className="font-medium text-lg">Flight</span>
                    </button>
                    <button 
                    ...
                    >
                      ...
                      <span className="font-medium text-lg">Hotel + Flight</span>
                    </button>
                  </div>
                </div>

                <div>
                  <h3 className="font-semibold text-xl text-gray-900 mb-4">Popular Destinations</h3>
              ...
              <div className="flex justify-end pt-6">
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-8 py-3 rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Continue
                </button>
              </div>
          ...
          {currentStep === 2 && (
            <div className="space-y-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-500 mt-2">Select your travel dates</p>
              </div>
              ...
              <div className="grid gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-600 focus:ring-2 focus:ring-blue-100 outline-none transition-colors"
                  />
                </div>
              ...
              <div className="flex justify-between pt-6">
                <button
                  ...
                  className="px-6 py-3 border-2 border-gray-200 rounded-xl text-gray-600 hover:border-blue-600 hover:text-blue-600 transition-colors"
                >
                  Back
                </button>
                <button
          ...
          {currentStep === 3 && (
            <div className="space-y-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-500 mt-2">Select number of travelers</p>
              </div>

              <div className="space-y-4">
                {/* Adults */}
                <div className="flex items-center justify-between p-4 rounded-xl border-2 border-gray-200 hover:border-blue-200 transition-all">
                  <div>
                  ...
                  <div className="flex items-center gap-4">
                    <button
                      ...
                      className="w-8 h-8 rounded-full border-2 border-gray-200 flex items-center justify-center text-gray-600 hover:border-blue-600 hover:text-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    >
                      -
                    </button>
                    ...
                    <button
                      ...
                      className="w-8 h-8 rounded-full border-2 border-gray-200 flex items-center justify-center text-gray-600 hover:border-blue-600 hover:text-blue-600 transition-colors"
                    >
                      +
                    </button>
                  </div>
              ...
              <div className="flex justify-between pt-6">
                ...
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-8 py-3 rounded-xl transition-all duration-200"
                >
                  Plan My Trip
                </button>
              </div>
